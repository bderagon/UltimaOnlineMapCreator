...
{
    public partial class LandTileSelector : Form
    {
        private Art UOArt;
        private int iSelected;

        public LandTileSelector()
        {
            MaximizeBox = false;
            MinimizeBox = false;
            this.iSelected = 0;
            ...
            do
            {
                ...
                do
                {
                    ...
                    if (Art.GetLand(value) != null)
                    {
                        ...
                        graphics.DrawImage(Art.GetLand(value), rectangle, rectangle1, GraphicsUnit.Pixel);
                        value++;
                    }
                    else
                    {
        ...
        private void Panel2_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ...
                this.iSelected = checked(checked(this.TileID.Value + checked(num1 * 6)) + num);
                object tag = this.Tag;
